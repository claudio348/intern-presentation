...
.slide.vcenter { justify-content:flex-start; padding-top:8vh; padding-bottom:4vh; }
.slide.vcenter > * { flex-shrink:0; }
.slide.vcenter .slide-head { margin-bottom:1.4vh; }
.slide.vcenter .chartframe .chart { max-height:60vh; width:auto; max-width:100%; margin:0 auto; }
