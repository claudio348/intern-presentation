...
.biz2-layer { display:flex; align-items:center; gap:1.6vw; border:1px solid rgba(12,12,12,.15); border-radius:16px; padding:2vh 1.8vw; flex:1 1 0; min-height:0; }
...
.bl-logos { display:flex; align-items:center; flex-wrap:wrap; gap:1vh 1.8vw; margin-top:1.6vh; }
.bl-logos img { height:clamp(17px,1.7vw,26px); width:auto; filter:grayscale(1); opacity:.6; }
...
.biz2-conn { display:flex; align-items:center; justify-content:center; gap:.8vw; flex:0 0 auto; padding:1.1vh 0; }
...
/* cedentes & sacados */
.cs-wrap { flex:1 1 auto; min-height:0; display:flex; flex-direction:column; gap:3vh; margin-top:2.4vh; }
