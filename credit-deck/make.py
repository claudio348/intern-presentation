...
kpi_labels = ptm(["may/25","jun/25","jul/25","aug/25","sep/25","oct/25","nov/25","dec/25","jan/26","feb/26","mar/26","apr/26","may/26"])
kpi_tenor = [3.52,3.46,3.40,3.33,3.18,3.11,3.05,3.12,3.33,3.38,3.42,3.42,3.45]
kpi_dur   = [2.09,2.15,2.18,2.08,2.09,1.97,1.97,1.93,2.07,2.20,2.30,2.22,2.34]
...
.slide.vcenter { justify-content:flex-start; padding-top:5.5vh; padding-bottom:3.5vh; }
...
.inv-amt { font-family:var(--font-sans); font-weight:700; font-size:clamp(22px,2vw,32px); letter-spacing:-.02em; color:#0C0C0C; line-height:1; }
...
/* cedentes & sacados */
.cs-grid { flex:1 1 auto; min-height:0; display:grid; grid-template-columns:1.6fr 1fr; gap:3vw; align-items:stretch; margin-top:2.4vh; }
.cs-cedentes, .cs-sacados { display:flex; flex-direction:column; min-height:0; }
.cs-lbl { font-family:var(--font-mono); font-size:10px; letter-spacing:.14em; text-transform:uppercase; color:#9a9a9a; display:flex; align-items:center; gap:.9vw; margin-bottom:1.8vh; }
.cs-hi { font-family:var(--font-mono); font-size:9px; letter-spacing:.04em; text-transform:none; color:#3A3A3A; border:1px solid rgba(12,12,12,.18); border-radius:100px; padding:3px 10px; }
.cs-feat { display:grid; grid-template-columns:1fr 1fr; gap:1.2vw; flex:0.9 1 0; min-height:0; }
.cs-feat-card { position:relative; border:1.6px solid #0C0C0C; border-radius:16px; padding:2vh 1.4vw; display:flex; align-items:center; justify-content:center; }
.cs-feat-card img { max-height:6.5vh; max-width:74%; width:auto; }
.cs-feat-tag { position:absolute; top:-9px; left:14px; background:#0C0C0C; color:#fff; font-family:var(--font-mono); font-size:8px; letter-spacing:.12em; text-transform:uppercase; padding:3px 9px; border-radius:100px; }
.cedente-wall { display:grid; grid-template-columns:repeat(3,1fr); gap:1vw; flex:1.1 1 0; min-height:0; margin-top:1vw; }
.cd { border:1px solid rgba(12,12,12,.14); border-radius:13px; display:flex; align-items:center; justify-content:center; padding:1.2vh 1vw; }
.cd img { max-height:4.4vh; max-width:80%; width:auto; }
.cd-more { font-family:var(--font-mono); font-size:10px; letter-spacing:.1em; text-transform:uppercase; color:#9a9a9a; border-style:dashed; }
.cs-metrics { display:flex; flex-direction:column; gap:1.4vh; flex:1 1 auto; min-height:0; }
.cs-metric { border:1px solid rgba(12,12,12,.14); border-radius:14px; padding:1.8vh 1.4vw; flex:1 1 0; display:flex; flex-direction:column; justify-content:center; }
.csm-k { font-family:var(--font-mono); font-size:9.5px; letter-spacing:.13em; text-transform:uppercase; color:#9a9a9a; }
.csm-v { font-family:var(--font-sans); font-weight:800; font-size:clamp(26px,2.4vw,38px); letter-spacing:-.02em; line-height:1; color:var(--ink); margin-top:.7vh; }
.csm-v em { font-style:normal; font-weight:600; font-size:.4em; color:#7a7a7a; margin-left:.15em; }
.csm-s { font-family:var(--font-mono); font-size:9px; letter-spacing:.08em; text-transform:uppercase; color:#C0143C; margin-top:.7vh; }
...
<section class="slide theme-light vcenter" data-num="02">
  ...
  <div class="cs-grid">
    <div class="cs-cedentes">
      <div class="cs-lbl">Cedentes · âncoras <span class="cs-hi">melhores do mercado: Intelbras &amp; Cantu</span></div>
      <div class="cs-feat reveal" data-stagger>
        <div class="cs-feat-card"><span class="cs-feat-tag">cedente destaque</span><img src="intelbras-logo.svg" alt="Intelbras"></div>
        <div class="cs-feat-card"><span class="cs-feat-tag">cedente destaque</span><img src="cantu-logo.svg" alt="Cantu"></div>
      </div>
      <div class="cedente-wall reveal" data-stagger>
        ...
        <div class="cd cd-more">+ novos cedentes</div>
      </div>
    </div>
    <div class="cs-sacados">
      <div class="cs-lbl">Sacados · PMEs tomadoras</div>
      <div class="cs-metrics reveal" data-stagger>
        <div class="cs-metric"><div class="csm-k">Idade média do tomador</div><div class="csm-v">— <em>anos</em></div><div class="csm-s">a confirmar</div></div>
        <div class="cs-metric"><div class="csm-k">Ticket médio</div><div class="csm-v">R$ —</div><div class="csm-s">a confirmar</div></div>
        <div class="cs-metric"><div class="csm-k">Limite médio aprovado</div><div class="csm-v">R$ —</div><div class="csm-s">a confirmar</div></div>
      </div>
    </div>
  </div>
  <div class="illus">Fonte: Robbin Data · cedentes e sacados</div>
</section>
...
<!-- 11 — Q&A -->
<section class="slide theme-dark closing2 has-ts" data-num="11">
