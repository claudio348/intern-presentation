...
.cs-feat { display:grid; grid-template-columns:1fr 1fr; gap:1.2vw; flex:1 1 auto; min-height:0; }
...
.cs-feat-card img { max-height:7vh; max-width:78%; width:auto; }
...
.cedente-wall { display:grid; grid-template-columns:1fr 1fr; gap:1.2vw; flex:1 1 auto; min-height:0; margin-top:1.2vw; }
.cd { border:1px solid rgba(12,12,12,.14); border-radius:14px; display:flex; align-items:center; justify-content:center; padding:1.6vh 1.2vw; }
.cd img { max-height:5vh; max-width:72%; width:auto; }
