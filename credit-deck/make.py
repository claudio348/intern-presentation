...
.giro-wrap { flex:1 1 auto; min-height:0; display:flex; flex-direction:column; justify-content:center; gap:3.5vh; }
...
/* cedentes & sacados */
.cs-wrap { flex:1 1 auto; min-height:0; display:flex; flex-direction:column; gap:2vh; margin-top:1.8vh; }
.cs-block { display:flex; flex-direction:column; min-height:0; }
.cs-block:first-child { flex:1.35 1 0; }
.cs-block:last-child { flex:1 1 0; }
...
.cd { border:1px solid rgba(12,12,12,.14); border-radius:13px; display:flex; align-items:center; justify-content:center; padding:1vh 1.2vw; }
...
.cs-metric { border:1px solid rgba(12,12,12,.14); border-radius:14px; padding:1.3vh 1.4vw; display:flex; flex-direction:column; justify-content:center; }
...
.csm-s { font-family:var(--font-mono); font-size:9px; letter-spacing:.08em; text-transform:uppercase; color:#9a9a9a; margin-top:.7vh; }
  ...
  <div class="cs-wrap">
    ...
    <div class="cs-block">
      ...
      <div class="cs-metrics reveal" data-stagger>
        <div class="cs-metric"><div class="csm-k">Idade média da empresa</div><div class="csm-v">12 <em>anos</em></div><div class="csm-s">do tomador (sacado)</div></div>
...
<!-- COMPANY — RUN RATE + CORPORATE BACKING (removido a pedido) -->
    ...
    <div class="ts-card reveal">
      ...
      <div class="ts-hero">
        ...
        <div class="ts-hero-side">
          <div><span class="k">Montante</span><span class="v">R$ 10M</span></div>
      ...
      <div class="ts-rows">
        ...
        <div class="ts-row"><span class="k">Amortização</span><span class="v">Bullet · juros mensais com 6 meses de carência</span></div>
